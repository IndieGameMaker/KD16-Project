...
| :---: | ---------- | ---------------------- | ------------- | ------ | -------------- | ------ |
|   1   | N.E.W.S    | Departure into unknown | Quest2, Sym4D | 김푸름 | 김푸름, 박현진 |        |
|   2   | AND VISION | END VISION             | Quest2        | 가유림 | 가유림, 이의림 |        |
...
- 프로젝트의 목적
  - 교육기간동안 습득한 VR 기술을 종합적으로 사용한 최종 프로젝트로서 전반적인 개발 과정을 이해하고 다양한 시행착오를 통해 개개인의 개발 역량을 강화한다.
