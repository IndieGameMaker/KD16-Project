...
- 발표일자 : 2023/11/20 09:30 ~ 11:00
- [발표 문서 업로드](https://drive.google.com/drive/folders/13sJHxoDgx59HvHnwywTcjqSZOc7PtBeo?usp=share_link)
...
| :---: | ---------------------------- | ------------------------------ | --------- | ------ | ---------------------- | ------------------------------------------------------ |
|   1   | M.J. 4D                      | Galactic Odyssey 4D            | VR, Sym4D | 서민우 | 서민우, 배정훈         | [링크](https://trello.com/b/qDPoSpaj/mj4d)             |
|   2   | Team 싹쓰리                  | bit to BYTE                    | VR        | 이주성 | 이승원, 이예은, 이주성 | [링크](https://trello.com/b/1izFjTeE/일정)             |
|   3   | Code Destroyer               | 멸망 직전의 세계(가졔)         | VR        | 문주왕 | 허지현, 문주왕         | [링크](https://trello.com/b/O1RLHnv0/vr15기team)       |
|   4   | 1인 프로젝트                 | N차원 벡터 매니폴드 프로그래밍 | VR        | 최규석 | 최규석                 | [링크](https://trello.com/b/d2q4P834/새로운프로그래밍) |
|   5   | 색깔 삼총사                  | Palette - What's your color    | VR        | 이명준 | 조휘준, 최승우, 이명준 | [링크](https://trello.com/b/7I7VQUJS/my-trello-board)  |
|   6   | 미사일연속발사시스템(미연시) | Tank You Very Much             | VR        | 이종민 | 이종민, 이미르, 김승범 | [링크](https://trello.com/b/UpCZPHVP/tankproject)      |
...
- UI 구성도
- 상세 기능 목록(엑셀, 구글 시트)
- [상세 설계 문서 업로드](https://drive.google.com/drive/folders/1DXuNXSvTqTIWbTZakICbVD6GWHqRAMy5?usp=share_link)
...
| **중간 점검**     | 12/15(금)                              |
| **발표 문서작성** | 12/20 ~                                |
| **발표 문서리뷰** | 1차 12/27(수) , 2차 12/28(목)          |
| **알파 테스트**   | 12/19(화)                              |
| **베타 테스트**   | 12/26(화)                              |
| **발표 리허설**   | 12/29 (09:30 ~)                        |
| **시연 및 발표**  | 01/02 (12:30부터 시연, 2:30 부터 발표) |
...
- 협업 및 형상관리
  - 일정관리는 **Trello** 또는 **Notion**을 활용하며 모니터링을 위해 지도 강사(myleje@gmail.com, wytm111@naver.com)를 초대한다. [(트렐로 trello.com)](https://trello.com) 
